...
Use responsive values to apply different bleed amounts at different screen sizes.
...
<Card>
  <Box padding="400">
    <Text as="h2" variant="headingMd">Responsive Content</Text>
    <Bleed marginInline={{xs: '200', md: '400', lg: '600'}}>
      <Box background="bg-surface-secondary" padding="400">
        <Text as="p">This content has different bleed amounts on different screen sizes</Text>
      </Box>
    </Bleed>
  </Box>
</Card>
...
Create a full-width section within a constrained layout.

```svelte
<script>
  import { Bleed, Card, Box, Text, Button, BlockStack, InlineStack } from 'svelte-polaris';
</script>
...
<Card>
  <Box padding="400">
    <BlockStack gap="400">
      ...
      <Text as="p">Standard product details go here with normal padding.</Text>
      
      <Bleed marginInline="400" marginBlockEnd="400">
        <Box background="bg-surface-critical" padding="400">
          <InlineStack align="space-between" blockAlign="center">
            <Text as="p" tone="critical">Important: This product is discontinued</Text>
            <Button variant="primary" tone="critical">Learn more</Button>
          </InlineStack>
        </Box>
      </Bleed>
    </BlockStack>
