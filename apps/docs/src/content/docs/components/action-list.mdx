...
<TabItem label="Preview">
  <Preview src="/components/action-list/" title="Action list preview" />
</TabItem>
<TabItem label="Code">
```svelte
<script>
...
<Tabs>
<TabItem label="Preview">
  <Preview src="/components/action-list?type=action-list-with-icons" title="Action list with icons preview" />
</TabItem>
<TabItem label="Code">
```svelte
<script>
...
<Tabs>
<TabItem label="Preview">
  <Preview src="/components/action-list?type=action-list-with-sections" title="Action list with sections preview" />
</TabItem>
<TabItem label="Code">
```svelte
<script>
