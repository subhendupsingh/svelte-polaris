...
<Grid gap="400">
  ...
  {#each metrics as metric}
    <Grid.Cell columnSpan={{ xs: 6, sm: 3, md: 3, lg: 3, xl: 3 }}>
      <Card>
        <BlockStack gap="200">
          <Text variant="bodyMd" tone="subdued">{metric.label}</Text>
  ...
  <Grid.Cell columnSpan={{ xs: 6, sm: 6, md: 8, lg: 8, xl: 8 }}>
    <Card>
      <BlockStack gap="400">
        <Text variant="headingMd">Sales Overview</Text>
  ...
  <Grid.Cell columnSpan={{ xs: 6, sm: 6, md: 4, lg: 4, xl: 4 }}>
    <Card>
      <BlockStack gap="400">
        ...
        <BlockStack gap="300">
          <div>
            <Text variant="bodyMd">New order #1234</Text>
            <Text variant="bodySm" tone="subdued">2 minutes ago</Text>
          </div>
          <div>
            <Text variant="bodyMd">Customer registered</Text>
            <Text variant="bodySm" tone="subdued">5 minutes ago</Text>
          </div>
          <div>
            <Text variant="bodyMd">Product updated</Text>
            <Text variant="bodySm" tone="subdued">10 minutes ago</Text>
          </div>
        </BlockStack>
  ...
  <Grid.Cell columnSpan={{ xs: 6, sm: 6, md: 6, lg: 6, xl: 6 }}>
    <Card>
      <BlockStack gap="400">
        <Text variant="headingMd">Store Settings</Text>
        <BlockStack gap="200">
